...
{
    return new V4l2H264DevUnicastServerMediaSubsession(env, dev, reuseFirstSource, width, height, fps, bitrate,
                    ...
                    unsigned& estBitrate)
{
    ...
    V4l2FFH264DevFramedSource* source = V4l2FFH264DevFramedSource::createNew(envir(), mDev.c_str(),
                                                                        mWidth, mHeight, mFps, mBitrate);
