...
//文档地址：https://linuxtv.org/downloads/v4l-dvb-apis/uapi/v4l/ext-ctrls-codec.html?highlight=v4l2_mpeg_video_h264_profile_main
//添加h264编码速率控制：
...
//添加h264编码sps/pps控制：
int v4l2_s_sps(int fd, int value);
/*
 * 函数名称：v4l2_open
 * 功能描述：打开v4l2设备
 * 输入参数：name - 设备名字
